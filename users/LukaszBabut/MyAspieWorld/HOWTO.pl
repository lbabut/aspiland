...
Tresura
    ...
    Średnio szło, więc zaczeły nas tresować.
    Zmuszać.
...
Wkurwiacze
    ...
    To aż tak proste.
    Zawsze i wszędzie dbaj o swój komfort. Dokładnie tak, jak lubisz.
...
1) Proszę wybrać swoją płeć: [ powiedzmy, że to jeszcze wybaczam... ]
2) Jak często masz trudności z uporządkowaniem rzeczy, gdy musisz wykonać zadanie wymagające organizacji?
    [co to kurwa znaczy "trudności z uporządkowaniem rzeczy"?!?!?]
    [co to jest "zadanie wymagające organizacji???]
3) Jak często masz problemy z zapamiętywaniem terminów lub obowiązków?
    [ po chuj mam to pamiętać?!?! Mam smartfona w kieszeni]
4) Kiedy masz zadanie, które wymaga dużo przemyśleń, jak często unikasz lub opóźniasz rozpoczęcie?
    [ to są jakieś zadania niewymagające przemyśleń ??]
5) Jak często „wiercisz się” (poruszasz rękami lub stopami), kiedy musisz długo siedzieć?
    [ ciągle, przeszkadza ci to? To spierdalaj :-) ]
6) Jak często popełniasz nieostrożne błędy, gdy musisz pracować nad nudnym lub trudnym zadaniem?
7) Jak często masz trudności z utrzymaniem uwagi, gdy wykonujesz nudną lub powtarzalną pracę?
    [ ciągle, bo to są kurwa nudne zadania - ja jestem stworzony do wyższych rzeczy.
    Jak mam nudny proces, to go kurwa automatyzuję i o nim zapominam. ]
8) Jak często masz trudności ze skupieniem się na tym, co ludzie do Ciebie mówią, nawet jeśli zwracają się do Ciebie bezpośrednio?
    [ ale co mówią? Pewnie pierdolą coś bez sensu - jak to małpy. Who cares!]
9) Jak często się gubisz lub masz trudności ze znalezieniem rzeczy w domu lub w pracy?
    [ małpy też by się pogubiły w mrowisku i chuja wiedziały, gdzie co leży.
      no i kto wam miasta projektuje wy pojeby? :-) ]
10) Jak często rozprasza Cię aktywność lub hałas wokół Ciebie?
    [ spróbujcie kurwa odczuwać hałas tak, jak my, to pogadamy.
       a tobie by przeszkadzał trzymetrowy chuj w dupie w bieganiu? 
       Ja pierdole! ]
11) Jak często czujesz się niespokojny lub niecierpliwy?
    [ w śród małp? zawsze ;-) ]
12) Jak często masz trudności z odprężeniem się i relaksem, gdy masz czas dla siebie?
    [ "czas dla siebie" - lol. One myślą, że mamy takie ficzery.
      nasze rozumienie relaksu i odprężenia też się ma nijak to małpiej wersji.
      To jak rozmawiać ze świnią o atronomii ]
13) Jak często przerywasz innym, kiedy są zajęci?
    [ A po czym się poznaje, że małpa jest zajęta?
    to działa w obie strony - my umiemy jednocześnie:
        - doskonale udawać małpę
        - robić kilka rzeczy
        - myśleć o całkiem innych
        - odpowiadać na wasze pojebane pytania
        - tłumaczyć z naszego na małpi
        - słuchać, wąchać, widzieć,
        - nie ruszać się 
        Małpa kiedy widzi jak siedzimy i się bujamy na krześle, to myśli, że nic nie robimy i że to jest OK, po
        prostu podejść i zacząć gadać coś po małmiemu.
        LOL - serio!]
14) Wolę robić coś razem z innymi niż samemu.
    [ no kurwa, raczej :-) 
      małpy mają o to jakiś ból dupy, czy coś?]
 15) Wolę wykonywać czynności zawsze w ten sam sposób.
    [ jeśli już poświęcam energię i używam ciała, do wykonania zmian w otoczeniu materialnym, to raczej wszysto uprzednio przemyślałem i robię to metodą, jaka mi pasuje.
       Metodą idealną.
       Odpierdolcie się :-)]
...
1) Podejdź do małpy
2) Popatrz jej przez chwilę w oczy [jakbyś widział coś ciekawego, interesującego ]
3) Obczaj, co robi z ręką - kto wyciąga pierwszy jest dla mnie nadal tajemnicą.
   Przypuszczam, że to sposób okazywania "władzy" u małp. Chcesz dominować = wyciągasz pierwszy
4) Kontakt fizyczny 
    [tak, wiem... obrzydliwe! Ale one jakoś tego "wymagają" ]
    No więc najtrudniejsza część: poćwicz przed lustrem - mogą zauważyć obrzydzenia i całe przywitanie w pidu
...
1) Przygotuj się
    - zdrób kopię danych z głowy (musi być fizyczna - najlepsza ołówkiem w ulubionym notesie) o:
       =  skąd, dokąd
       = kiedy
    = mapa skąd 
        = mapa do kąd
...
3) Na miejscu
    ...
    Podtrzymać funkcje ciała ( oddychanie głównie najważniejsze )
...
Kosmetyczka		fajki		mały plecak	noce:	7							2
Kosmetyczka	x	Chujsteczki Do noska	ok										
Kosmetyczka	x	kosmetyczka !! Maszynka itepe + bloker !!!	rano										
Kosmetyczka	x	Leki 											
Kosmetyczka	x	okulary p. słoneczne, kontaktowe											
Kosmetyczka	x	Kapcie po hotelu											
Papiery	x	paszport, wyjazdowe, kasa											
Sprzęt	x	roaming	ok										
Sprzęt	x	telefony, aparat, ładowarki, akumulatorki, latarka		mały plecak									
Sprzęt	x	Coś do wpierdalania w samolocie	ok										
Survival	x	kawa, cukier, żarcie	ok										
Survival	x	kołdra, poduszki	ok										
Survival	x	Świeczki	ok										
Ubrania	x	Adidaski	ok										
Ubrania		Bluzy ciepłe	rano										
Ubrania		Buty											
Ubrania		Buty do sniegowania / latania	rano										
Ubrania	x	czapka	rano										
Ubrania	x	Dresikl	ok										
Ubrania	x	Kapielówki	ok										
Ubrania	x	Klapki prysznoicowe	ok										
Ubrania	x	Koszulki	ok										
Ubrania	x	Kurtka zimowa	ok										
Ubrania	x	Majty	ok										
Ubrania	x	Ręcznik	ok										
Ubrania	x	rękawiczki i szalik	ok										
Ubrania	x	Skarpetki	ok										
Ubrania	x	Spodnie dł	ok										
Ubrania	x	Sprodnie kr.											
Ubrania	x	miętówki	ok										
Ubrania	x	Sztormiak 	rano	mały plecak									
Ubrania	x	T-szerty	ok										
papiery	x	Glajtowe papiery	ok										
Ubrania	x	maska z rurkąn do pływania	ok										
	x	śpiwór											
	x	Ubezpieczenie !!!											
x		Do paznokci											
		Lapki, zasilacze											
		słuchawki											
		gajerek											
		buty biznesowe i ciupciarka buciana											
		koszule krawaty											
		pasek biznesowy											
		Taksówka na rano !!											
		...
		- wygodne buty, najlepiej za kostkę lub inne trekkingowe											
		- ciepłe skarpety											
													
		- termos na gorącą herbatę											
		- bidon na wodę lub po prostu woda											
